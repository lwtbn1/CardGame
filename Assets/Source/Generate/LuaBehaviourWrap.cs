...
public class LuaBehaviourWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("OnToggleValueChange", OnToggleValueChange);
		L.RegFunction("RemoveToggleValueChange", RemoveToggleValueChange);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int OnToggleValueChange(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 3);
			...
			UnityEngine.GameObject arg0 = (UnityEngine.GameObject)ToLua.CheckUnityObject(L, 2, typeof(UnityEngine.GameObject));
			LuaFunction arg1 = ToLua.CheckLuaFunction(L, 3);
			obj.OnToggleValueChange(arg0, arg1);
			return 0;
		}
		catch(Exception e)
		{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int RemoveToggleValueChange(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 2);
			LuaBehaviour obj = (LuaBehaviour)ToLua.CheckObject(L, 1, typeof(LuaBehaviour));
			UnityEngine.GameObject arg0 = (UnityEngine.GameObject)ToLua.CheckUnityObject(L, 2, typeof(UnityEngine.GameObject));
			obj.RemoveToggleValueChange(arg0);
			return 0;
		}
		catch(Exception e)
		{
